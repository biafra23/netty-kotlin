...
internal class Hidden {
     ...
     */
    @UnstableApi
    class NettyBlockHoundIntegration : BlockHoundIntegration {
        ...
        override fun applyTo(builder: BlockHound.Builder) {
            ...
            builder.nonBlockingThreadPredicate(Function { p ->
                Predicate { thread ->
                    p.test(thread) ||
                            thread is FastThreadLocalThread &&
                            !thread.permitBlockingCalls()
                }
            })
        }

        override fun compareTo(other: BlockHoundIntegration): Int = 0
    }
}
