 ...
 */
interface UncheckedBooleanSupplier : BooleanSupplier {
    /**
    ...
    companion object {
         ...
         */
        @JvmField
        val FALSE_SUPPLIER: UncheckedBooleanSupplier = object : UncheckedBooleanSupplier {
         ...
         */
        @JvmField
        val TRUE_SUPPLIER: UncheckedBooleanSupplier = object : UncheckedBooleanSupplier {
