...
interface SizeClassesMetric {
     ...
     * @return size
     */
    fun sizeIdx2size(sizeIdx: Int): Int
     ...
     * @return size
     */
    fun sizeIdx2sizeCompute(sizeIdx: Int): Int
     ...
     */
    fun pageIdx2size(pageIdx: Int): Long
     ...
     * @return size which is multiples of pageSize
     */
    fun pageIdx2sizeCompute(pageIdx: Int): Long
     ...
     */
    fun pages2pageIdx(pages: Int): Int
     ...
     * @return pageIdx of the pageSize class
     */
    fun pages2pageIdxFloor(pages: Int): Int
