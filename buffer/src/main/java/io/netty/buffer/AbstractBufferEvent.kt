...
@Suppress("Since15")
internal abstract class AbstractBufferEvent : AbstractAllocatorEvent() {
    @DataAmount
    ...
    fun fill(buf: AbstractByteBuf, allocatorType: Class<out AbstractByteBufAllocator>) {
